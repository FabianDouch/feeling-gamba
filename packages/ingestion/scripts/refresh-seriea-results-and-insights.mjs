...
/**
 * Maps a calendar date to the Serie A season start year.
 */
function getDefaultSerieaSeasonYear(date) {
...
function parseArgs(argv) {
  ...
  const options = {
    ...
    season: getDefaultSerieaSeasonYear(now),
    skipInsights: false,
...
function buildRefreshCommands(options) {
  ...
  commands.push(buildCommand("refresh_official_seriea_results", "refresh-football-league-results-from-json.mjs", resultFlags));
