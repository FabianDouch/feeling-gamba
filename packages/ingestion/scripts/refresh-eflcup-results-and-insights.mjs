...
/**
 * Maps a calendar date to the EFL Cup season start year.
 */
function getDefaultEflcupSeasonYear(date) {
...
function parseArgs(argv) {
  ...
  const options = {
    ...
    season: getDefaultEflcupSeasonYear(now),
    skipInsights: false,
...
function buildRefreshCommands(options) {
  ...
  commands.push(buildCommand("refresh_official_efl_cup_results", "refresh-football-league-results-from-json.mjs", resultFlags));
