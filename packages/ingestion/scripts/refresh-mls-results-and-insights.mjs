...
/**
 * Maps a calendar date to the MLS season start year.
 */
function getDefaultMlsSeasonYear(date) {
...
function parseArgs(argv) {
  ...
  const options = {
    ...
    season: getDefaultMlsSeasonYear(now),
    skipInsights: false,
...
function buildRefreshCommands(options) {
  ...
  commands.push(buildCommand("refresh_official_mls_results", "refresh-football-league-results-from-json.mjs", resultFlags));
