...
/**
 * Maps a calendar date to the Ligue 1 season start year.
 */
function getDefaultLigue1SeasonYear(date) {
...
function parseArgs(argv) {
  ...
  const options = {
    ...
    season: getDefaultLigue1SeasonYear(now),
    skipInsights: false,
...
function buildRefreshCommands(options) {
  ...
  commands.push(buildCommand("refresh_official_ligue1_results", "refresh-football-league-results-from-json.mjs", resultFlags));
