...
/**
 * Maps a calendar date to the Europa League season start year.
 */
function getDefaultEuropaleagueSeasonYear(date) {
...
function parseArgs(argv) {
  ...
  const options = {
    ...
    season: getDefaultEuropaleagueSeasonYear(now),
    skipInsights: false,
...
function buildRefreshCommands(options) {
  ...
  commands.push(buildCommand("refresh_official_europa_league_results", "refresh-football-league-results-from-json.mjs", resultFlags));
