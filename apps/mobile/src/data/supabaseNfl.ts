...
export type NflPriceBucketSize = "0.25" | "0.50";

export type NflInsightBreakdown = {
...
export type NflFixedWinPriceRole = "favourite" | "underdog" | "home" | "away";

export type NflFixedWinPriceBreakdowns = Record<NflFixedWinPriceRole, NflInsightBreakdown[]>;
export type NflFixedWinPriceBreakdownGroups = Record<NflPriceBucketSize, NflFixedWinPriceBreakdowns>;
export type NflPriceBreakdownGroups = Record<NflPriceBucketSize, NflInsightBreakdown[]>;

export type NflInsightsData = {
  fixedWinOtherTeamPriceBreakdown: NflFixedWinPriceBreakdownGroups;
  fixedWinOtherTeamPriceBreakdownPlus: NflFixedWinPriceBreakdownGroups;
  fixedWinPriceDifferenceBreakdown: NflFixedWinPriceBreakdownGroups;
  fixedWinPriceDifferenceBreakdownPlus: NflFixedWinPriceBreakdownGroups;
  fixedWinPriceBreakdown: NflFixedWinPriceBreakdownGroups;
  fixedWinPriceBreakdownPlus: NflFixedWinPriceBreakdownGroups;
  fixedWinRoundBreakdown: NflInsightBreakdown[];
  fixedWinSelectionBreakdown: NflInsightBreakdown[];
  fixedWinSummaryStats: FavouriteStat[];
  halfTimeFullTimeSelectionBreakdown: NflInsightBreakdown[];
  halfTimeFullTimeSummaryStats: FavouriteStat[];
  sameGameRoundBreakdown: NflInsightBreakdown[];
  sameGameSummaryStats: FavouriteStat[];
  tryScorerPlayerBreakdown: NflInsightBreakdown[];
  tryScorerPriceBreakdown: NflPriceBreakdownGroups;
  tryScorerSummaryStats: FavouriteStat[];
  tryScorerTeamBreakdown: NflInsightBreakdown[];
};

type NflInsightAggregateRow = {
  average_return_per_dollar: NullableNumber;
  event_count: number;
  insight_type: NflInsightType;
  ...
  scope_key: string;
  scope_type: NflInsightScopeType;
  season: number | null;
...
type NflInsightType = "fixed_win_single" | "half_time_full_time_double" | "same_game_multi_percentage" | "try_scorer_percentage";

type NflInsightScopeType =
  | "overall"
...
export const hasSupabaseNflConfig = Boolean(
  publicEnv.supabaseUrl && publicEnv.supabaseKey,
);

/**
 * Reads the stored NFL aggregate rows shown in the NFL Insights view.
 */
export async function fetchNflInsights(): Promise<NflInsightsData> {
  const [
    fixedWinOverallRows,
    fixedWinPriceRows,
    ...
    fetchNflAggregateRows("fixed_win_single", "overall", {
      scope_key: "eq.nfl:fixed_win_single:overall:favourite",
    }),
    fetchNflAggregateRows("fixed_win_single", "price_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchNflAggregateRows("fixed_win_single", "price_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchNflAggregateRows("fixed_win_single", "other_team_price_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchNflAggregateRows("fixed_win_single", "other_team_price_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchNflAggregateRows("fixed_win_single", "price_difference_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchNflAggregateRows("fixed_win_single", "price_difference_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchNflAggregateRows("fixed_win_single", "favourite_venue"),
    fetchNflAggregateRows("fixed_win_single", "selection_type"),
    fetchNflAggregateRows("fixed_win_single", "season_round", {
      order: "season.desc,round_number.desc",
    }),
    fetchNflAggregateRows("half_time_full_time_double", "overall", {
      scope_key: "eq.nfl:half_time_full_time_double:overall:favourite",
    }),
    fetchNflAggregateRows("half_time_full_time_double", "favourite_venue"),
    fetchNflAggregateRows("half_time_full_time_double", "selection_type"),
    fetchNflAggregateRows("same_game_multi_percentage", "overall", {
      scope_key: "eq.nfl:same_game_multi_percentage:overall:favourite_top2_try_scorers",
    }),
    fetchNflAggregateRows("same_game_multi_percentage", "season_round", {
      order: "season.desc,round_number.desc",
    }),
    fetchNflAggregateRows("try_scorer_percentage", "overall"),
    fetchNflAggregateRows("try_scorer_percentage", "player", {
      limit: "12",
      order: "win_percentage.desc,selection_count.desc,player_name.asc",
    }),
    fetchNflAggregateRows("try_scorer_percentage", "price_bucket", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchNflAggregateRows("try_scorer_percentage", "team", {
 ...
 */
function mapHalfTimeFullTimeSummaryStats(row: NflInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapSameGameSummaryStats(row: NflInsightAggregateRow): FavouriteStat[] {
  return [
    {
...
/**
 * Reads one NFL aggregate scope from Supabase.
 */
async function fetchNflAggregateRows(
  insightType: NflInsightType,
  scopeType: NflInsightScopeType,
  extraParams: Record<string, string> = {},
) {
  return supabaseSelectAll<NflInsightAggregateRow>("nfl_insight_aggregates", {
    insight_type: `eq.${insightType}`,
    scope_type: `eq.${scopeType}`,
    select: NFL_INSIGHT_SELECT,
    ...extraParams,
  });
}
 ...
 */
function mapFixedWinSummaryStats(row: NflInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapFixedWinPriceBreakdowns(rows: NflInsightAggregateRow[]): NflFixedWinPriceBreakdownGroups {
...
function mapPriceBreakdownGroups(
  rows: NflInsightAggregateRow[],
  mapRow: (row: NflInsightAggregateRow) => NflInsightBreakdown,
): NflPriceBreakdownGroups {
  const groups: NflPriceBreakdownGroups = {
    "0.25": [],
    "0.50": [],
  };
 ...
 */
function createFixedWinPriceBreakdownGroups(): NflFixedWinPriceBreakdownGroups {
  return {
    "0.25": {
      away: [],
      favourite: [],
 ...
 */
function getBucketSizeKey(value: NullableNumber): NflPriceBucketSize {
 ...
 */
function mapTryScorerSummaryStats(row: NflInsightAggregateRow): FavouriteStat[] {
  return [
    {
    ...
    {
      detail: `${row.total_tries} tries from official NFL timeline rows`,
...
/**
 * Maps a fixed-win aggregate row to the generic NFL breakdown display model.
 */
function mapFixedWinBreakdown(row: NflInsightAggregateRow): NflInsightBreakdown {
  return {
    ...
    label: getNflAggregateLabel(row),
...
/**
 * Maps a half-time/full-time aggregate row to the generic NFL breakdown display model.
 */
function mapHalfTimeFullTimeBreakdown(row: NflInsightAggregateRow): NflInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
...
/**
 * Maps a try-scorer aggregate row to the generic NFL breakdown display model.
 */
function mapTryScorerBreakdown(row: NflInsightAggregateRow): NflInsightBreakdown {
...
/**
 * Maps a same-game multi aggregate row to the generic NFL breakdown display model.
 */
function mapSameGameBreakdown(row: NflInsightAggregateRow): NflInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
 ...
 */
function getNflAggregateLabel(row: NflInsightAggregateRow) {
  if (isNflPriceBucketScope(row.scope_type) && row.price_bucket_label) {
...
/**
 * Identifies NFL aggregate scopes that use the shared price bucket fields.
 */
function isNflPriceBucketScope(scopeType: NflInsightScopeType) {
...
/**
 * Formats favourite/underdog/home/away selection labels for NFL fixed-win rows.
 */
 ...
 */
function compareFixedWinSelectionRows(left: NflInsightAggregateRow, right: NflInsightAggregateRow) {
