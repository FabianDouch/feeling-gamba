...
export type EuropaleaguePriceBucketSize = "0.25" | "0.50";

export type EuropaleagueInsightBreakdown = {
...
export type EuropaleagueFixedWinPriceRole = "favourite" | "underdog" | "home" | "away";

export type EuropaleagueFixedWinPriceBreakdowns = Record<EuropaleagueFixedWinPriceRole, EuropaleagueInsightBreakdown[]>;
export type EuropaleagueFixedWinPriceBreakdownGroups = Record<EuropaleaguePriceBucketSize, EuropaleagueFixedWinPriceBreakdowns>;
export type EuropaleaguePriceBreakdownGroups = Record<EuropaleaguePriceBucketSize, EuropaleagueInsightBreakdown[]>;

export type EuropaleagueInsightsData = {
  fixedDrawPriceBreakdown: EuropaleaguePriceBreakdownGroups;
  fixedDrawPriceBreakdownPlus: EuropaleaguePriceBreakdownGroups;
  fixedDrawSummaryStats: FavouriteStat[];
  fixedWinOtherTeamPriceBreakdown: EuropaleagueFixedWinPriceBreakdownGroups;
  fixedWinOtherTeamPriceBreakdownPlus: EuropaleagueFixedWinPriceBreakdownGroups;
  fixedWinPriceDifferenceBreakdown: EuropaleagueFixedWinPriceBreakdownGroups;
  fixedWinPriceDifferenceBreakdownPlus: EuropaleagueFixedWinPriceBreakdownGroups;
  fixedWinPriceBreakdown: EuropaleagueFixedWinPriceBreakdownGroups;
  fixedWinPriceBreakdownPlus: EuropaleagueFixedWinPriceBreakdownGroups;
  fixedWinRoundBreakdown: EuropaleagueInsightBreakdown[];
  fixedWinSelectionBreakdown: EuropaleagueInsightBreakdown[];
  fixedWinSummaryStats: FavouriteStat[];
  halfTimeFullTimeSelectionBreakdown: EuropaleagueInsightBreakdown[];
  halfTimeFullTimeSummaryStats: FavouriteStat[];
  sameGameRoundBreakdown: EuropaleagueInsightBreakdown[];
  sameGameSummaryStats: FavouriteStat[];
  tryScorerPlayerBreakdown: EuropaleagueInsightBreakdown[];
  tryScorerPriceBreakdown: EuropaleaguePriceBreakdownGroups;
  tryScorerSummaryStats: FavouriteStat[];
  tryScorerTeamBreakdown: EuropaleagueInsightBreakdown[];
};

type EuropaleagueInsightAggregateRow = {
  average_return_per_dollar: NullableNumber;
  event_count: number;
  insight_type: EuropaleagueInsightType;
  ...
  scope_key: string;
  scope_type: EuropaleagueInsightScopeType;
  season: number | null;
...
type EuropaleagueInsightType = "fixed_win_single" | "fixed_draw_single" | "half_time_full_time_double" | "same_game_multi_percentage" | "goal_scorer_percentage";

type EuropaleagueInsightScopeType =
  | "overall"
...
const EUROPALEAGUE_INSIGHT_SELECT = [
...
export const hasSupabaseEuropaleagueConfig = Boolean(
  publicEnv.supabaseUrl && publicEnv.supabaseKey,
);

/**
 * Reads the stored Europa League aggregate rows shown in the Europa League Insights view.
 */
export async function fetchEuropaleagueInsights(): Promise<EuropaleagueInsightsData> {
  const [
    fixedWinOverallRows,
    fixedWinPriceRows,
    ...
    fetchEuropaleagueAggregateRows("fixed_win_single", "overall", {
      scope_key: "eq.europaleague:fixed_win_single:overall:favourite",
    }),
    fetchEuropaleagueAggregateRows("fixed_win_single", "price_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEuropaleagueAggregateRows("fixed_win_single", "price_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEuropaleagueAggregateRows("fixed_win_single", "other_team_price_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEuropaleagueAggregateRows("fixed_win_single", "other_team_price_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEuropaleagueAggregateRows("fixed_win_single", "price_difference_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEuropaleagueAggregateRows("fixed_win_single", "price_difference_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEuropaleagueAggregateRows("fixed_win_single", "favourite_venue"),
    fetchEuropaleagueAggregateRows("fixed_win_single", "selection_type"),
    fetchEuropaleagueAggregateRows("fixed_win_single", "season_round", {
      order: "season.desc,round_number.desc",
    }),
    fetchEuropaleagueAggregateRows("fixed_draw_single", "overall", {
      scope_key: "eq.europaleague:fixed_draw_single:overall:draw",
    }),
    fetchEuropaleagueAggregateRows("fixed_draw_single", "price_bucket", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEuropaleagueAggregateRows("fixed_draw_single", "price_bucket_plus", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEuropaleagueAggregateRows("half_time_full_time_double", "overall", {
      scope_key: "eq.europaleague:half_time_full_time_double:overall:favourite",
    }),
    fetchEuropaleagueAggregateRows("half_time_full_time_double", "favourite_venue"),
    fetchEuropaleagueAggregateRows("half_time_full_time_double", "selection_type"),
    fetchEuropaleagueAggregateRows("same_game_multi_percentage", "overall", {
      scope_key: "eq.europaleague:same_game_multi_percentage:overall:favourite_top2_goal_scorers",
    }),
    fetchEuropaleagueAggregateRows("same_game_multi_percentage", "season_round", {
      order: "season.desc,round_number.desc",
    }),
    fetchEuropaleagueAggregateRows("goal_scorer_percentage", "overall"),
    fetchEuropaleagueAggregateRows("goal_scorer_percentage", "player", {
      limit: "12",
      order: "win_percentage.desc,selection_count.desc,player_name.asc",
    }),
    fetchEuropaleagueAggregateRows("goal_scorer_percentage", "price_bucket", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEuropaleagueAggregateRows("goal_scorer_percentage", "team", {
 ...
 */
function mapFixedDrawSummaryStats(row: EuropaleagueInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapHalfTimeFullTimeSummaryStats(row: EuropaleagueInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapSameGameSummaryStats(row: EuropaleagueInsightAggregateRow): FavouriteStat[] {
  return [
    {
...
/**
 * Reads one Europa League aggregate scope from Supabase.
 */
async function fetchEuropaleagueAggregateRows(
  insightType: EuropaleagueInsightType,
  scopeType: EuropaleagueInsightScopeType,
  extraParams: Record<string, string> = {},
) {
  return supabaseSelectAll<EuropaleagueInsightAggregateRow>("europaleague_insight_aggregates", {
    insight_type: `eq.${insightType}`,
    scope_type: `eq.${scopeType}`,
    select: EUROPALEAGUE_INSIGHT_SELECT,
    ...extraParams,
  });
}
 ...
 */
function mapFixedWinSummaryStats(row: EuropaleagueInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapFixedWinPriceBreakdowns(rows: EuropaleagueInsightAggregateRow[]): EuropaleagueFixedWinPriceBreakdownGroups {
...
function mapPriceBreakdownGroups(
  rows: EuropaleagueInsightAggregateRow[],
  mapRow: (row: EuropaleagueInsightAggregateRow) => EuropaleagueInsightBreakdown,
): EuropaleaguePriceBreakdownGroups {
  const groups: EuropaleaguePriceBreakdownGroups = {
    "0.25": [],
    "0.50": [],
  };
 ...
 */
function createFixedWinPriceBreakdownGroups(): EuropaleagueFixedWinPriceBreakdownGroups {
  return {
    "0.25": {
      away: [],
      favourite: [],
 ...
 */
function getBucketSizeKey(value: NullableNumber): EuropaleaguePriceBucketSize {
 ...
 */
function mapGoalScorerSummaryStats(row: EuropaleagueInsightAggregateRow): FavouriteStat[] {
  return [
    {
    ...
    {
      detail: `${row.total_goals} goals from official Europa League timeline rows`,
...
/**
 * Maps a fixed-win aggregate row to the generic Europa League breakdown display model.
 */
function mapFixedWinBreakdown(row: EuropaleagueInsightAggregateRow): EuropaleagueInsightBreakdown {
  return {
    ...
    label: getEuropaleagueAggregateLabel(row),
...
/**
 * Maps a fixed-draw aggregate row to the generic Europa League breakdown display model.
 */
function mapFixedDrawBreakdown(row: EuropaleagueInsightAggregateRow): EuropaleagueInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
    detail: `${row.win_count} draws from ${row.selection_count} settled matches`,
    label: getEuropaleagueAggregateLabel(row),
...
/**
 * Maps a half-time/full-time aggregate row to the generic Europa League breakdown display model.
 */
function mapHalfTimeFullTimeBreakdown(row: EuropaleagueInsightAggregateRow): EuropaleagueInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
...
/**
 * Maps a goal-scorer aggregate row to the generic Europa League breakdown display model.
 */
function mapGoalScorerBreakdown(row: EuropaleagueInsightAggregateRow): EuropaleagueInsightBreakdown {
...
/**
 * Maps a same-game multi aggregate row to the generic Europa League breakdown display model.
 */
function mapSameGameBreakdown(row: EuropaleagueInsightAggregateRow): EuropaleagueInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
 ...
 */
function getEuropaleagueAggregateLabel(row: EuropaleagueInsightAggregateRow) {
  if (isEuropaleaguePriceBucketScope(row.scope_type) && row.price_bucket_label) {
...
/**
 * Identifies Europa League aggregate scopes that use the shared price bucket fields.
 */
function isEuropaleaguePriceBucketScope(scopeType: EuropaleagueInsightScopeType) {
...
/**
 * Formats favourite/underdog/home/away selection labels for Europa League fixed-win rows.
 */
 ...
 */
function compareFixedWinSelectionRows(left: EuropaleagueInsightAggregateRow, right: EuropaleagueInsightAggregateRow) {
