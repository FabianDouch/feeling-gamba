...
export type UclPriceBucketSize = "0.25" | "0.50";

export type UclInsightBreakdown = {
...
export type UclPriceBreakdownGroups = Record<UclPriceBucketSize, UclInsightBreakdown[]>;

export type UclInsightsData = {
  fixedDrawPriceBreakdown: UclPriceBreakdownGroups;
  fixedDrawPriceBreakdownPlus: UclPriceBreakdownGroups;
  fixedDrawSummaryStats: FavouriteStat[];
  fixedWinOtherTeamPriceBreakdown: UclFixedWinPriceBreakdownGroups;
  fixedWinOtherTeamPriceBreakdownPlus: UclFixedWinPriceBreakdownGroups;
  fixedWinPriceDifferenceBreakdown: UclFixedWinPriceBreakdownGroups;
  fixedWinPriceDifferenceBreakdownPlus: UclFixedWinPriceBreakdownGroups;
  fixedWinPriceBreakdown: UclFixedWinPriceBreakdownGroups;
  fixedWinPriceBreakdownPlus: UclFixedWinPriceBreakdownGroups;
  fixedWinRoundBreakdown: UclInsightBreakdown[];
  fixedWinSelectionBreakdown: UclInsightBreakdown[];
  fixedWinSummaryStats: FavouriteStat[];
  halfTimeFullTimeSelectionBreakdown: UclInsightBreakdown[];
  halfTimeFullTimeSummaryStats: FavouriteStat[];
  sameGameRoundBreakdown: UclInsightBreakdown[];
  sameGameSummaryStats: FavouriteStat[];
  tryScorerPlayerBreakdown: UclInsightBreakdown[];
  tryScorerPriceBreakdown: UclPriceBreakdownGroups;
  tryScorerSummaryStats: FavouriteStat[];
  tryScorerTeamBreakdown: UclInsightBreakdown[];
};

type UclInsightAggregateRow = {
  average_return_per_dollar: NullableNumber;
  event_count: number;
  insight_type: UclInsightType;
  ...
  scope_key: string;
  scope_type: UclInsightScopeType;
  season: number | null;
...
type UclInsightType = "fixed_win_single" | "fixed_draw_single" | "half_time_full_time_double" | "same_game_multi_percentage" | "goal_scorer_percentage";

type UclInsightScopeType =
  | "overall"
...
/**
 * Reads the stored UCL aggregate rows shown in the UCL Insights view.
 */
export async function fetchUclInsights(): Promise<UclInsightsData> {
  const [
    fixedWinOverallRows,
    fixedWinPriceRows,
    ...
    fetchUclAggregateRows("fixed_win_single", "overall", {
      scope_key: "eq.ucl:fixed_win_single:overall:favourite",
    }),
    fetchUclAggregateRows("fixed_win_single", "price_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchUclAggregateRows("fixed_win_single", "price_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchUclAggregateRows("fixed_win_single", "other_team_price_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchUclAggregateRows("fixed_win_single", "other_team_price_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchUclAggregateRows("fixed_win_single", "price_difference_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchUclAggregateRows("fixed_win_single", "price_difference_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchUclAggregateRows("fixed_win_single", "favourite_venue"),
    fetchUclAggregateRows("fixed_win_single", "selection_type"),
    fetchUclAggregateRows("fixed_win_single", "season_round", {
      order: "season.desc,round_number.desc",
    }),
    fetchUclAggregateRows("fixed_draw_single", "overall", {
      scope_key: "eq.ucl:fixed_draw_single:overall:draw",
    }),
    fetchUclAggregateRows("fixed_draw_single", "price_bucket", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchUclAggregateRows("fixed_draw_single", "price_bucket_plus", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchUclAggregateRows("half_time_full_time_double", "overall", {
      scope_key: "eq.ucl:half_time_full_time_double:overall:favourite",
    }),
    fetchUclAggregateRows("half_time_full_time_double", "favourite_venue"),
    fetchUclAggregateRows("half_time_full_time_double", "selection_type"),
    fetchUclAggregateRows("same_game_multi_percentage", "overall", {
      scope_key: "eq.ucl:same_game_multi_percentage:overall:favourite_top2_goal_scorers",
    }),
    fetchUclAggregateRows("same_game_multi_percentage", "season_round", {
      order: "season.desc,round_number.desc",
    }),
    fetchUclAggregateRows("goal_scorer_percentage", "overall"),
    fetchUclAggregateRows("goal_scorer_percentage", "player", {
      limit: "12",
      order: "win_percentage.desc,selection_count.desc,player_name.asc",
    }),
    fetchUclAggregateRows("goal_scorer_percentage", "price_bucket", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchUclAggregateRows("goal_scorer_percentage", "team", {
 ...
 */
function mapFixedDrawSummaryStats(row: UclInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapHalfTimeFullTimeSummaryStats(row: UclInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapSameGameSummaryStats(row: UclInsightAggregateRow): FavouriteStat[] {
  return [
    {
...
/**
 * Reads one UCL aggregate scope from Supabase.
 */
async function fetchUclAggregateRows(
  insightType: UclInsightType,
  scopeType: UclInsightScopeType,
  extraParams: Record<string, string> = {},
) {
  return supabaseSelectAll<UclInsightAggregateRow>("ucl_insight_aggregates", {
    insight_type: `eq.${insightType}`,
    scope_type: `eq.${scopeType}`,
    select: UCL_INSIGHT_SELECT,
    ...extraParams,
  });
}
 ...
 */
function mapFixedWinSummaryStats(row: UclInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapFixedWinPriceBreakdowns(rows: UclInsightAggregateRow[]): UclFixedWinPriceBreakdownGroups {
...
function mapPriceBreakdownGroups(
  rows: UclInsightAggregateRow[],
  mapRow: (row: UclInsightAggregateRow) => UclInsightBreakdown,
): UclPriceBreakdownGroups {
  const groups: UclPriceBreakdownGroups = {
    "0.25": [],
    "0.50": [],
  };
 ...
 */
function createFixedWinPriceBreakdownGroups(): UclFixedWinPriceBreakdownGroups {
  return {
    "0.25": {
      away: [],
      favourite: [],
 ...
 */
function getBucketSizeKey(value: NullableNumber): UclPriceBucketSize {
 ...
 */
function mapGoalScorerSummaryStats(row: UclInsightAggregateRow): FavouriteStat[] {
  return [
    {
    ...
    {
      detail: `${row.total_goals} goals from official UCL timeline rows`,
...
/**
 * Maps a fixed-win aggregate row to the generic UCL breakdown display model.
 */
function mapFixedWinBreakdown(row: UclInsightAggregateRow): UclInsightBreakdown {
  return {
    ...
    label: getUclAggregateLabel(row),
...
/**
 * Maps a fixed-draw aggregate row to the generic UCL breakdown display model.
 */
function mapFixedDrawBreakdown(row: UclInsightAggregateRow): UclInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
    detail: `${row.win_count} draws from ${row.selection_count} settled matches`,
    label: getUclAggregateLabel(row),
...
/**
 * Maps a half-time/full-time aggregate row to the generic UCL breakdown display model.
 */
function mapHalfTimeFullTimeBreakdown(row: UclInsightAggregateRow): UclInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
...
/**
 * Maps a goal-scorer aggregate row to the generic UCL breakdown display model.
 */
function mapGoalScorerBreakdown(row: UclInsightAggregateRow): UclInsightBreakdown {
...
/**
 * Maps a same-game multi aggregate row to the generic UCL breakdown display model.
 */
function mapSameGameBreakdown(row: UclInsightAggregateRow): UclInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
 ...
 */
function getUclAggregateLabel(row: UclInsightAggregateRow) {
  if (isUclPriceBucketScope(row.scope_type) && row.price_bucket_label) {
...
/**
 * Identifies UCL aggregate scopes that use the shared price bucket fields.
 */
function isUclPriceBucketScope(scopeType: UclInsightScopeType) {
 ...
 */
function compareFixedWinSelectionRows(left: UclInsightAggregateRow, right: UclInsightAggregateRow) {
