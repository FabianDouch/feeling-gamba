...
export type EflcupPriceBucketSize = "0.25" | "0.50";

export type EflcupInsightBreakdown = {
...
export type EflcupFixedWinPriceRole = "favourite" | "underdog" | "home" | "away";

export type EflcupFixedWinPriceBreakdowns = Record<EflcupFixedWinPriceRole, EflcupInsightBreakdown[]>;
export type EflcupFixedWinPriceBreakdownGroups = Record<EflcupPriceBucketSize, EflcupFixedWinPriceBreakdowns>;
export type EflcupPriceBreakdownGroups = Record<EflcupPriceBucketSize, EflcupInsightBreakdown[]>;

export type EflcupInsightsData = {
  fixedDrawPriceBreakdown: EflcupPriceBreakdownGroups;
  fixedDrawPriceBreakdownPlus: EflcupPriceBreakdownGroups;
  fixedDrawSummaryStats: FavouriteStat[];
  fixedWinOtherTeamPriceBreakdown: EflcupFixedWinPriceBreakdownGroups;
  fixedWinOtherTeamPriceBreakdownPlus: EflcupFixedWinPriceBreakdownGroups;
  fixedWinPriceDifferenceBreakdown: EflcupFixedWinPriceBreakdownGroups;
  fixedWinPriceDifferenceBreakdownPlus: EflcupFixedWinPriceBreakdownGroups;
  fixedWinPriceBreakdown: EflcupFixedWinPriceBreakdownGroups;
  fixedWinPriceBreakdownPlus: EflcupFixedWinPriceBreakdownGroups;
  fixedWinRoundBreakdown: EflcupInsightBreakdown[];
  fixedWinSelectionBreakdown: EflcupInsightBreakdown[];
  fixedWinSummaryStats: FavouriteStat[];
  halfTimeFullTimeSelectionBreakdown: EflcupInsightBreakdown[];
  halfTimeFullTimeSummaryStats: FavouriteStat[];
  sameGameRoundBreakdown: EflcupInsightBreakdown[];
  sameGameSummaryStats: FavouriteStat[];
  tryScorerPlayerBreakdown: EflcupInsightBreakdown[];
  tryScorerPriceBreakdown: EflcupPriceBreakdownGroups;
  tryScorerSummaryStats: FavouriteStat[];
  tryScorerTeamBreakdown: EflcupInsightBreakdown[];
};

type EflcupInsightAggregateRow = {
  average_return_per_dollar: NullableNumber;
  event_count: number;
  insight_type: EflcupInsightType;
  ...
  scope_key: string;
  scope_type: EflcupInsightScopeType;
  season: number | null;
...
type EflcupInsightType = "fixed_win_single" | "fixed_draw_single" | "half_time_full_time_double" | "same_game_multi_percentage" | "goal_scorer_percentage";

type EflcupInsightScopeType =
  | "overall"
...
export const hasSupabaseEflcupConfig = Boolean(
  publicEnv.supabaseUrl && publicEnv.supabaseKey,
);

/**
 * Reads the stored EFL Cup aggregate rows shown in the EFL Cup Insights view.
 */
export async function fetchEflcupInsights(): Promise<EflcupInsightsData> {
  const [
    fixedWinOverallRows,
    fixedWinPriceRows,
    ...
    fetchEflcupAggregateRows("fixed_win_single", "overall", {
      scope_key: "eq.eflcup:fixed_win_single:overall:favourite",
    }),
    fetchEflcupAggregateRows("fixed_win_single", "price_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEflcupAggregateRows("fixed_win_single", "price_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEflcupAggregateRows("fixed_win_single", "other_team_price_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEflcupAggregateRows("fixed_win_single", "other_team_price_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEflcupAggregateRows("fixed_win_single", "price_difference_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEflcupAggregateRows("fixed_win_single", "price_difference_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEflcupAggregateRows("fixed_win_single", "favourite_venue"),
    fetchEflcupAggregateRows("fixed_win_single", "selection_type"),
    fetchEflcupAggregateRows("fixed_win_single", "season_round", {
      order: "season.desc,round_number.desc",
    }),
    fetchEflcupAggregateRows("fixed_draw_single", "overall", {
      scope_key: "eq.eflcup:fixed_draw_single:overall:draw",
    }),
    fetchEflcupAggregateRows("fixed_draw_single", "price_bucket", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEflcupAggregateRows("fixed_draw_single", "price_bucket_plus", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEflcupAggregateRows("half_time_full_time_double", "overall", {
      scope_key: "eq.eflcup:half_time_full_time_double:overall:favourite",
    }),
    fetchEflcupAggregateRows("half_time_full_time_double", "favourite_venue"),
    fetchEflcupAggregateRows("half_time_full_time_double", "selection_type"),
    fetchEflcupAggregateRows("same_game_multi_percentage", "overall", {
      scope_key: "eq.eflcup:same_game_multi_percentage:overall:favourite_top2_goal_scorers",
    }),
    fetchEflcupAggregateRows("same_game_multi_percentage", "season_round", {
      order: "season.desc,round_number.desc",
    }),
    fetchEflcupAggregateRows("goal_scorer_percentage", "overall"),
    fetchEflcupAggregateRows("goal_scorer_percentage", "player", {
      limit: "12",
      order: "win_percentage.desc,selection_count.desc,player_name.asc",
    }),
    fetchEflcupAggregateRows("goal_scorer_percentage", "price_bucket", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchEflcupAggregateRows("goal_scorer_percentage", "team", {
 ...
 */
function mapFixedDrawSummaryStats(row: EflcupInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapHalfTimeFullTimeSummaryStats(row: EflcupInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapSameGameSummaryStats(row: EflcupInsightAggregateRow): FavouriteStat[] {
  return [
    {
...
/**
 * Reads one EFL Cup aggregate scope from Supabase.
 */
async function fetchEflcupAggregateRows(
  insightType: EflcupInsightType,
  scopeType: EflcupInsightScopeType,
  extraParams: Record<string, string> = {},
) {
  return supabaseSelectAll<EflcupInsightAggregateRow>("eflcup_insight_aggregates", {
    insight_type: `eq.${insightType}`,
    scope_type: `eq.${scopeType}`,
    select: EFLCUP_INSIGHT_SELECT,
    ...extraParams,
  });
}
 ...
 */
function mapFixedWinSummaryStats(row: EflcupInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapFixedWinPriceBreakdowns(rows: EflcupInsightAggregateRow[]): EflcupFixedWinPriceBreakdownGroups {
...
function mapPriceBreakdownGroups(
  rows: EflcupInsightAggregateRow[],
  mapRow: (row: EflcupInsightAggregateRow) => EflcupInsightBreakdown,
): EflcupPriceBreakdownGroups {
  const groups: EflcupPriceBreakdownGroups = {
    "0.25": [],
    "0.50": [],
  };
 ...
 */
function createFixedWinPriceBreakdownGroups(): EflcupFixedWinPriceBreakdownGroups {
  return {
    "0.25": {
      away: [],
      favourite: [],
 ...
 */
function getBucketSizeKey(value: NullableNumber): EflcupPriceBucketSize {
 ...
 */
function mapGoalScorerSummaryStats(row: EflcupInsightAggregateRow): FavouriteStat[] {
  return [
    {
    ...
    {
      detail: `${row.total_goals} goals from official EFL Cup timeline rows`,
...
/**
 * Maps a fixed-win aggregate row to the generic EFL Cup breakdown display model.
 */
function mapFixedWinBreakdown(row: EflcupInsightAggregateRow): EflcupInsightBreakdown {
  return {
    ...
    label: getEflcupAggregateLabel(row),
...
/**
 * Maps a fixed-draw aggregate row to the generic EFL Cup breakdown display model.
 */
function mapFixedDrawBreakdown(row: EflcupInsightAggregateRow): EflcupInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
    detail: `${row.win_count} draws from ${row.selection_count} settled matches`,
    label: getEflcupAggregateLabel(row),
...
/**
 * Maps a half-time/full-time aggregate row to the generic EFL Cup breakdown display model.
 */
function mapHalfTimeFullTimeBreakdown(row: EflcupInsightAggregateRow): EflcupInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
...
/**
 * Maps a goal-scorer aggregate row to the generic EFL Cup breakdown display model.
 */
function mapGoalScorerBreakdown(row: EflcupInsightAggregateRow): EflcupInsightBreakdown {
...
/**
 * Maps a same-game multi aggregate row to the generic EFL Cup breakdown display model.
 */
function mapSameGameBreakdown(row: EflcupInsightAggregateRow): EflcupInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
 ...
 */
function getEflcupAggregateLabel(row: EflcupInsightAggregateRow) {
  if (isEflcupPriceBucketScope(row.scope_type) && row.price_bucket_label) {
...
/**
 * Identifies EFL Cup aggregate scopes that use the shared price bucket fields.
 */
function isEflcupPriceBucketScope(scopeType: EflcupInsightScopeType) {
...
/**
 * Formats favourite/underdog/home/away selection labels for EFL Cup fixed-win rows.
 */
 ...
 */
function compareFixedWinSelectionRows(left: EflcupInsightAggregateRow, right: EflcupInsightAggregateRow) {
