...
export type LaligaPriceBucketSize = "0.25" | "0.50";

export type LaligaInsightBreakdown = {
...
export type LaligaFixedWinPriceRole = "favourite" | "underdog" | "home" | "away";

export type LaligaFixedWinPriceBreakdowns = Record<LaligaFixedWinPriceRole, LaligaInsightBreakdown[]>;
export type LaligaFixedWinPriceBreakdownGroups = Record<LaligaPriceBucketSize, LaligaFixedWinPriceBreakdowns>;
export type LaligaPriceBreakdownGroups = Record<LaligaPriceBucketSize, LaligaInsightBreakdown[]>;

export type LaligaInsightsData = {
  fixedDrawPriceBreakdown: LaligaPriceBreakdownGroups;
  fixedDrawPriceBreakdownPlus: LaligaPriceBreakdownGroups;
  fixedDrawSummaryStats: FavouriteStat[];
  fixedWinOtherTeamPriceBreakdown: LaligaFixedWinPriceBreakdownGroups;
  fixedWinOtherTeamPriceBreakdownPlus: LaligaFixedWinPriceBreakdownGroups;
  fixedWinPriceDifferenceBreakdown: LaligaFixedWinPriceBreakdownGroups;
  fixedWinPriceDifferenceBreakdownPlus: LaligaFixedWinPriceBreakdownGroups;
  fixedWinPriceBreakdown: LaligaFixedWinPriceBreakdownGroups;
  fixedWinPriceBreakdownPlus: LaligaFixedWinPriceBreakdownGroups;
  fixedWinRoundBreakdown: LaligaInsightBreakdown[];
  fixedWinSelectionBreakdown: LaligaInsightBreakdown[];
  fixedWinSummaryStats: FavouriteStat[];
  halfTimeFullTimeSelectionBreakdown: LaligaInsightBreakdown[];
  halfTimeFullTimeSummaryStats: FavouriteStat[];
  sameGameRoundBreakdown: LaligaInsightBreakdown[];
  sameGameSummaryStats: FavouriteStat[];
  tryScorerPlayerBreakdown: LaligaInsightBreakdown[];
  tryScorerPriceBreakdown: LaligaPriceBreakdownGroups;
  tryScorerSummaryStats: FavouriteStat[];
  tryScorerTeamBreakdown: LaligaInsightBreakdown[];
};

type LaligaInsightAggregateRow = {
  average_return_per_dollar: NullableNumber;
  event_count: number;
  insight_type: LaligaInsightType;
  ...
  scope_key: string;
  scope_type: LaligaInsightScopeType;
  season: number | null;
...
type LaligaInsightType = "fixed_win_single" | "fixed_draw_single" | "half_time_full_time_double" | "same_game_multi_percentage" | "goal_scorer_percentage";

type LaligaInsightScopeType =
  | "overall"
...
export const hasSupabaseLaligaConfig = Boolean(
  publicEnv.supabaseUrl && publicEnv.supabaseKey,
);

/**
 * Reads the stored La Liga aggregate rows shown in the La Liga Insights view.
 */
export async function fetchLaligaInsights(): Promise<LaligaInsightsData> {
  const [
    fixedWinOverallRows,
    fixedWinPriceRows,
    ...
    fetchLaligaAggregateRows("fixed_win_single", "overall", {
      scope_key: "eq.laliga:fixed_win_single:overall:favourite",
    }),
    fetchLaligaAggregateRows("fixed_win_single", "price_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchLaligaAggregateRows("fixed_win_single", "price_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchLaligaAggregateRows("fixed_win_single", "other_team_price_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchLaligaAggregateRows("fixed_win_single", "other_team_price_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchLaligaAggregateRows("fixed_win_single", "price_difference_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchLaligaAggregateRows("fixed_win_single", "price_difference_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchLaligaAggregateRows("fixed_win_single", "favourite_venue"),
    fetchLaligaAggregateRows("fixed_win_single", "selection_type"),
    fetchLaligaAggregateRows("fixed_win_single", "season_round", {
      order: "season.desc,round_number.desc",
    }),
    fetchLaligaAggregateRows("fixed_draw_single", "overall", {
      scope_key: "eq.laliga:fixed_draw_single:overall:draw",
    }),
    fetchLaligaAggregateRows("fixed_draw_single", "price_bucket", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchLaligaAggregateRows("fixed_draw_single", "price_bucket_plus", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchLaligaAggregateRows("half_time_full_time_double", "overall", {
      scope_key: "eq.laliga:half_time_full_time_double:overall:favourite",
    }),
    fetchLaligaAggregateRows("half_time_full_time_double", "favourite_venue"),
    fetchLaligaAggregateRows("half_time_full_time_double", "selection_type"),
    fetchLaligaAggregateRows("same_game_multi_percentage", "overall", {
      scope_key: "eq.laliga:same_game_multi_percentage:overall:favourite_top2_goal_scorers",
    }),
    fetchLaligaAggregateRows("same_game_multi_percentage", "season_round", {
      order: "season.desc,round_number.desc",
    }),
    fetchLaligaAggregateRows("goal_scorer_percentage", "overall"),
    fetchLaligaAggregateRows("goal_scorer_percentage", "player", {
      limit: "12",
      order: "win_percentage.desc,selection_count.desc,player_name.asc",
    }),
    fetchLaligaAggregateRows("goal_scorer_percentage", "price_bucket", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchLaligaAggregateRows("goal_scorer_percentage", "team", {
 ...
 */
function mapFixedDrawSummaryStats(row: LaligaInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapHalfTimeFullTimeSummaryStats(row: LaligaInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapSameGameSummaryStats(row: LaligaInsightAggregateRow): FavouriteStat[] {
  return [
    {
...
/**
 * Reads one La Liga aggregate scope from Supabase.
 */
async function fetchLaligaAggregateRows(
  insightType: LaligaInsightType,
  scopeType: LaligaInsightScopeType,
  extraParams: Record<string, string> = {},
) {
  return supabaseSelectAll<LaligaInsightAggregateRow>("laliga_insight_aggregates", {
    insight_type: `eq.${insightType}`,
    scope_type: `eq.${scopeType}`,
    select: LALIGA_INSIGHT_SELECT,
    ...extraParams,
  });
}
 ...
 */
function mapFixedWinSummaryStats(row: LaligaInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapFixedWinPriceBreakdowns(rows: LaligaInsightAggregateRow[]): LaligaFixedWinPriceBreakdownGroups {
...
function mapPriceBreakdownGroups(
  rows: LaligaInsightAggregateRow[],
  mapRow: (row: LaligaInsightAggregateRow) => LaligaInsightBreakdown,
): LaligaPriceBreakdownGroups {
  const groups: LaligaPriceBreakdownGroups = {
    "0.25": [],
    "0.50": [],
  };
 ...
 */
function createFixedWinPriceBreakdownGroups(): LaligaFixedWinPriceBreakdownGroups {
  return {
    "0.25": {
      away: [],
      favourite: [],
 ...
 */
function getBucketSizeKey(value: NullableNumber): LaligaPriceBucketSize {
 ...
 */
function mapGoalScorerSummaryStats(row: LaligaInsightAggregateRow): FavouriteStat[] {
  return [
    {
    ...
    {
      detail: `${row.total_goals} goals from official La Liga timeline rows`,
...
/**
 * Maps a fixed-win aggregate row to the generic La Liga breakdown display model.
 */
function mapFixedWinBreakdown(row: LaligaInsightAggregateRow): LaligaInsightBreakdown {
  return {
    ...
    label: getLaligaAggregateLabel(row),
...
/**
 * Maps a fixed-draw aggregate row to the generic La Liga breakdown display model.
 */
function mapFixedDrawBreakdown(row: LaligaInsightAggregateRow): LaligaInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
    detail: `${row.win_count} draws from ${row.selection_count} settled matches`,
    label: getLaligaAggregateLabel(row),
...
/**
 * Maps a half-time/full-time aggregate row to the generic La Liga breakdown display model.
 */
function mapHalfTimeFullTimeBreakdown(row: LaligaInsightAggregateRow): LaligaInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
...
/**
 * Maps a goal-scorer aggregate row to the generic La Liga breakdown display model.
 */
function mapGoalScorerBreakdown(row: LaligaInsightAggregateRow): LaligaInsightBreakdown {
...
/**
 * Maps a same-game multi aggregate row to the generic La Liga breakdown display model.
 */
function mapSameGameBreakdown(row: LaligaInsightAggregateRow): LaligaInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
 ...
 */
function getLaligaAggregateLabel(row: LaligaInsightAggregateRow) {
  if (isLaligaPriceBucketScope(row.scope_type) && row.price_bucket_label) {
...
/**
 * Identifies La Liga aggregate scopes that use the shared price bucket fields.
 */
function isLaligaPriceBucketScope(scopeType: LaligaInsightScopeType) {
...
/**
 * Formats favourite/underdog/home/away selection labels for La Liga fixed-win rows.
 */
 ...
 */
function compareFixedWinSelectionRows(left: LaligaInsightAggregateRow, right: LaligaInsightAggregateRow) {
