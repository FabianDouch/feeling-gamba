...
export type SerieaPriceBucketSize = "0.25" | "0.50";

export type SerieaInsightBreakdown = {
...
export type SerieaFixedWinPriceRole = "favourite" | "underdog" | "home" | "away";

export type SerieaFixedWinPriceBreakdowns = Record<SerieaFixedWinPriceRole, SerieaInsightBreakdown[]>;
export type SerieaFixedWinPriceBreakdownGroups = Record<SerieaPriceBucketSize, SerieaFixedWinPriceBreakdowns>;
export type SerieaPriceBreakdownGroups = Record<SerieaPriceBucketSize, SerieaInsightBreakdown[]>;

export type SerieaInsightsData = {
  fixedDrawPriceBreakdown: SerieaPriceBreakdownGroups;
  fixedDrawPriceBreakdownPlus: SerieaPriceBreakdownGroups;
  fixedDrawSummaryStats: FavouriteStat[];
  fixedWinOtherTeamPriceBreakdown: SerieaFixedWinPriceBreakdownGroups;
  fixedWinOtherTeamPriceBreakdownPlus: SerieaFixedWinPriceBreakdownGroups;
  fixedWinPriceDifferenceBreakdown: SerieaFixedWinPriceBreakdownGroups;
  fixedWinPriceDifferenceBreakdownPlus: SerieaFixedWinPriceBreakdownGroups;
  fixedWinPriceBreakdown: SerieaFixedWinPriceBreakdownGroups;
  fixedWinPriceBreakdownPlus: SerieaFixedWinPriceBreakdownGroups;
  fixedWinRoundBreakdown: SerieaInsightBreakdown[];
  fixedWinSelectionBreakdown: SerieaInsightBreakdown[];
  fixedWinSummaryStats: FavouriteStat[];
  halfTimeFullTimeSelectionBreakdown: SerieaInsightBreakdown[];
  halfTimeFullTimeSummaryStats: FavouriteStat[];
  sameGameRoundBreakdown: SerieaInsightBreakdown[];
  sameGameSummaryStats: FavouriteStat[];
  tryScorerPlayerBreakdown: SerieaInsightBreakdown[];
  tryScorerPriceBreakdown: SerieaPriceBreakdownGroups;
  tryScorerSummaryStats: FavouriteStat[];
  tryScorerTeamBreakdown: SerieaInsightBreakdown[];
};

type SerieaInsightAggregateRow = {
  average_return_per_dollar: NullableNumber;
  event_count: number;
  insight_type: SerieaInsightType;
  ...
  scope_key: string;
  scope_type: SerieaInsightScopeType;
  season: number | null;
...
type SerieaInsightType = "fixed_win_single" | "fixed_draw_single" | "half_time_full_time_double" | "same_game_multi_percentage" | "goal_scorer_percentage";

type SerieaInsightScopeType =
  | "overall"
...
export const hasSupabaseSerieaConfig = Boolean(
  publicEnv.supabaseUrl && publicEnv.supabaseKey,
);

/**
 * Reads the stored Serie A aggregate rows shown in the Serie A Insights view.
 */
export async function fetchSerieaInsights(): Promise<SerieaInsightsData> {
  const [
    fixedWinOverallRows,
    fixedWinPriceRows,
    ...
    fetchSerieaAggregateRows("fixed_win_single", "overall", {
      scope_key: "eq.seriea:fixed_win_single:overall:favourite",
    }),
    fetchSerieaAggregateRows("fixed_win_single", "price_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchSerieaAggregateRows("fixed_win_single", "price_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchSerieaAggregateRows("fixed_win_single", "other_team_price_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchSerieaAggregateRows("fixed_win_single", "other_team_price_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchSerieaAggregateRows("fixed_win_single", "price_difference_bucket", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchSerieaAggregateRows("fixed_win_single", "price_difference_bucket_plus", {
      order: "selection_type.asc,bucket_size.desc,price_bucket_start.asc",
    }),
    fetchSerieaAggregateRows("fixed_win_single", "favourite_venue"),
    fetchSerieaAggregateRows("fixed_win_single", "selection_type"),
    fetchSerieaAggregateRows("fixed_win_single", "season_round", {
      order: "season.desc,round_number.desc",
    }),
    fetchSerieaAggregateRows("fixed_draw_single", "overall", {
      scope_key: "eq.seriea:fixed_draw_single:overall:draw",
    }),
    fetchSerieaAggregateRows("fixed_draw_single", "price_bucket", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchSerieaAggregateRows("fixed_draw_single", "price_bucket_plus", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchSerieaAggregateRows("half_time_full_time_double", "overall", {
      scope_key: "eq.seriea:half_time_full_time_double:overall:favourite",
    }),
    fetchSerieaAggregateRows("half_time_full_time_double", "favourite_venue"),
    fetchSerieaAggregateRows("half_time_full_time_double", "selection_type"),
    fetchSerieaAggregateRows("same_game_multi_percentage", "overall", {
      scope_key: "eq.seriea:same_game_multi_percentage:overall:favourite_top2_goal_scorers",
    }),
    fetchSerieaAggregateRows("same_game_multi_percentage", "season_round", {
      order: "season.desc,round_number.desc",
    }),
    fetchSerieaAggregateRows("goal_scorer_percentage", "overall"),
    fetchSerieaAggregateRows("goal_scorer_percentage", "player", {
      limit: "12",
      order: "win_percentage.desc,selection_count.desc,player_name.asc",
    }),
    fetchSerieaAggregateRows("goal_scorer_percentage", "price_bucket", {
      order: "bucket_size.desc,price_bucket_start.asc",
    }),
    fetchSerieaAggregateRows("goal_scorer_percentage", "team", {
 ...
 */
function mapFixedDrawSummaryStats(row: SerieaInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapHalfTimeFullTimeSummaryStats(row: SerieaInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapSameGameSummaryStats(row: SerieaInsightAggregateRow): FavouriteStat[] {
  return [
    {
...
/**
 * Reads one Serie A aggregate scope from Supabase.
 */
async function fetchSerieaAggregateRows(
  insightType: SerieaInsightType,
  scopeType: SerieaInsightScopeType,
  extraParams: Record<string, string> = {},
) {
  return supabaseSelectAll<SerieaInsightAggregateRow>("seriea_insight_aggregates", {
    insight_type: `eq.${insightType}`,
    scope_type: `eq.${scopeType}`,
    select: SERIEA_INSIGHT_SELECT,
    ...extraParams,
  });
}
 ...
 */
function mapFixedWinSummaryStats(row: SerieaInsightAggregateRow): FavouriteStat[] {
  return [
    {
 ...
 */
function mapFixedWinPriceBreakdowns(rows: SerieaInsightAggregateRow[]): SerieaFixedWinPriceBreakdownGroups {
...
function mapPriceBreakdownGroups(
  rows: SerieaInsightAggregateRow[],
  mapRow: (row: SerieaInsightAggregateRow) => SerieaInsightBreakdown,
): SerieaPriceBreakdownGroups {
  const groups: SerieaPriceBreakdownGroups = {
    "0.25": [],
    "0.50": [],
  };
 ...
 */
function createFixedWinPriceBreakdownGroups(): SerieaFixedWinPriceBreakdownGroups {
  return {
    "0.25": {
      away: [],
      favourite: [],
 ...
 */
function getBucketSizeKey(value: NullableNumber): SerieaPriceBucketSize {
 ...
 */
function mapGoalScorerSummaryStats(row: SerieaInsightAggregateRow): FavouriteStat[] {
  return [
    {
    ...
    {
      detail: `${row.total_goals} goals from official Serie A timeline rows`,
...
/**
 * Maps a fixed-win aggregate row to the generic Serie A breakdown display model.
 */
function mapFixedWinBreakdown(row: SerieaInsightAggregateRow): SerieaInsightBreakdown {
  return {
    ...
    label: getSerieaAggregateLabel(row),
...
/**
 * Maps a fixed-draw aggregate row to the generic Serie A breakdown display model.
 */
function mapFixedDrawBreakdown(row: SerieaInsightAggregateRow): SerieaInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
    detail: `${row.win_count} draws from ${row.selection_count} settled matches`,
    label: getSerieaAggregateLabel(row),
...
/**
 * Maps a half-time/full-time aggregate row to the generic Serie A breakdown display model.
 */
function mapHalfTimeFullTimeBreakdown(row: SerieaInsightAggregateRow): SerieaInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
...
/**
 * Maps a goal-scorer aggregate row to the generic Serie A breakdown display model.
 */
function mapGoalScorerBreakdown(row: SerieaInsightAggregateRow): SerieaInsightBreakdown {
...
/**
 * Maps a same-game multi aggregate row to the generic Serie A breakdown display model.
 */
function mapSameGameBreakdown(row: SerieaInsightAggregateRow): SerieaInsightBreakdown {
  return {
    averageReturn: formatReturn(numeric(row.average_return_per_dollar)),
 ...
 */
function getSerieaAggregateLabel(row: SerieaInsightAggregateRow) {
  if (isSerieaPriceBucketScope(row.scope_type) && row.price_bucket_label) {
...
/**
 * Identifies Serie A aggregate scopes that use the shared price bucket fields.
 */
function isSerieaPriceBucketScope(scopeType: SerieaInsightScopeType) {
...
/**
 * Formats favourite/underdog/home/away selection labels for Serie A fixed-win rows.
 */
 ...
 */
function compareFixedWinSelectionRows(left: SerieaInsightAggregateRow, right: SerieaInsightAggregateRow) {
